from transformers.models.bart.modeling_bart import BartPretrainedModel, BartConfig
from transformers.models.bart.modeling_bart import BartLearnedPositionalEmbedding, BartEncoderLayer, _expand_mask, BartDecoderLayer, _make_causal_mask
...
class BartEncoder(BartPretrainedModel):
    ...
    def __init__(self, config: BartConfig, embed_tokens: Optional[nn.Embedding] = None):
        ...
        self.n_head = config.encoder_attention_heads
        self.n_embd = config.d_model // config.encoder_attention_heads
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            raw_embeds = self.embed_tokens(input_ids) * self.embed_scale
...
class BARTOriginalDecoder(BartPretrainedModel):
    """
...
class BartPromptForConditionalGeneration(BartPretrainedModel):
    ...
    def forward(
        ...
        if past_key_values is None:
            sequence_outputs = sequence_outputs[:, self.pre_seq_len:, :].contiguous()
        else:
            sequence_outputs = sequence_outputs

        lm_logits = self.lm_head(sequence_outputs) + self.final_logits_bias
